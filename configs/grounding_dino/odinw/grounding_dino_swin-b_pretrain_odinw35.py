...
metainfo = dict(classes=class_name)
_data_root = (
    data_root + "AmericanSignLanguageLetters/American Sign Language Letters.v1-v1.coco/"
)  # noqa
...
metainfo = dict(classes=class_name)
_data_root = (
    data_root + "NorthAmericaMushrooms/North American Mushrooms.v1-416x416.coco/"
)  # noqa
...
caption_prompt = {
    "pothole": {"name": "holes", "prefix": "there are some ", "suffix": " on the road"}
}
