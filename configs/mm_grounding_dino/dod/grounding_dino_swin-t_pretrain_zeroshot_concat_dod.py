...
val_evaluator_full = dict(
    type="DODCocoMetric", ann_file=data_root + "d3_json/d3_full_annotations.json"
)
...
val_evaluator_pres = dict(
    type="DODCocoMetric", ann_file=data_root + "d3_json/d3_pres_annotations.json"
)
...
val_evaluator_abs = dict(
    type="DODCocoMetric", ann_file=data_root + "d3_json/d3_abs_annotations.json"
)
