...
test_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/BlueBerry23.v1i.coco-mmdetection/annotations/instances_test.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
val_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/BlueBerry23.v1i.coco-mmdetection/annotations/instances_val.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
