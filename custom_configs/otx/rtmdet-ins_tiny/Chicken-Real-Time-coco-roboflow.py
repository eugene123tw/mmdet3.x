...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root="/home/yuchunli/_DATASET/Chicken-Real-Time-coco-roboflow",
        metainfo=dict(
            classes=[
                "chicken",
                "0.06",
...
test_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/Chicken-Real-Time-coco-roboflow/annotations/instances_test.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
val_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/Chicken-Real-Time-coco-roboflow/annotations/instances_val.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
work_dir = "work_dirs/rtmdet-ins_tiny/Chicken-Real-Time-coco-roboflow"
