...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root="/home/yuchunli/_DATASET/car-seg.v1i.coco-mmdetection",
        metainfo=dict(
            classes=[
                "back_bumper",
                "back_glass",
...
test_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/car-seg.v1i.coco-mmdetection/annotations/instances_test.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
val_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/car-seg.v1i.coco-mmdetection/annotations/instances_val.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
work_dir = "work_dirs/rtmdet-ins_tiny/car-seg.v1i.coco-mmdetection"
