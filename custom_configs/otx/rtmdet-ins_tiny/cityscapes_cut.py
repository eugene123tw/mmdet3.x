...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root="/home/yuchunli/_DATASET/cityscapes_cut",
        metainfo=dict(
            classes=[
                "person",
                "rider",
...
test_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/cityscapes_cut/annotations/instances_test.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
val_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/cityscapes_cut/annotations/instances_val.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
work_dir = "work_dirs/rtmdet-ins_tiny/cityscapes_cut"
