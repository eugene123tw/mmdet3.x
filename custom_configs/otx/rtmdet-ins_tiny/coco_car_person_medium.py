...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root="/home/yuchunli/_DATASET/coco_car_person_medium",
        metainfo=dict(
            classes=[
                "person",
                "car",
...
test_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/coco_car_person_medium/annotations/instances_test.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
val_evaluator = dict(
    ann_file="/home/yuchunli/_DATASET/coco_car_person_medium/annotations/instances_val.json",
    backend_args=None,
    format_only=False,
    metric=[
        "bbox",
...
work_dir = "work_dirs/rtmdet-ins_tiny/coco_car_person_medium"
