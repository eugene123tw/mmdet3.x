...
train_dataloader = dict(
    ...
    dataset=dict(
        type="CocoDataset",
        data_root="/home/yuchunli/_DATASET/coco-shorten/",
...
val_evaluator = dict(
    type="CocoMetric",
    ann_file="/home/yuchunli/_DATASET/coco/annotations/instances_val2017.json",
    metric=["bbox", "segm"],
    format_only=False,
    backend_args=None,
...
test_evaluator = dict(
    type="CocoMetric",
    ann_file="/home/yuchunli/_DATASET/coco-shorten/annotations/instances_test.json",
    metric=["bbox", "segm"],
    format_only=False,
    backend_args=None,
    proposal_nums=(100, 1, 10),
